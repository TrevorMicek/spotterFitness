...
const IndexPage = () => (
    <Layout title="Spotter Fitness" pageLayout={{gridTemplateRows: "[top-gutter] auto [top-padding] auto [first] auto"}}>
      ...
      <FirstSection comp={Testimonials}  skew="right" bg="rgb(231,208,175)"  zTop="8" zBottom="8" pad="15vh"  />
      <FirstSection comp={Download} skew="none" bg="white" borderTop="none" zTop="9" zBottom="9"  />
      <FirstSection comp={Cities} skew="none" bg="white" borderTop="none" zTop="10" zBottom="10" pad="15vh"  />
