...
return (
  <div style={{position: 'relative', zIndex:'12', top: '-3vh', zIndex: '21', background: "linear-gradient(90deg, #e7d0af, #d8bf9e, #caae8d, #bc9d7d, #ae8c6d, #a07c5e, #926c4f, #845c41)"}}>
    <div className="font-default h-24 py-0 ">
    <div className="max-w-7xl mx-auto text-center pt-3 px-4 sm:px-6 lg:py-16 lg:px-8">
    <div className="relative">
          <h2 className="text-center mb-0 -mt-2 text-black text-xs leading-8 tracking-tight ">
            WE ARE LIVE IN
          </h2>
        ...
        <h3 className="-mt-3 text-white text-xs tracking-tight">
