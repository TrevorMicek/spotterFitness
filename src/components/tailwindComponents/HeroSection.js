          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <nav className="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
              <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0" >
                <div className="border-b-2 flex items-center justify-between w-full md:w-auto">
                  <a href="#">
          ...
          <div className="text-center">
            ...
            <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
              <div className="flex items-center justify-center rounded-md shadow">
                <a
                  href="#"
                  className="w-max px-6 py-2 border border-transparent text-base font-medium rounded-md text-black bg-indigo-50 hover:bg-indigo-50 md:py-4 md:text-lg md:px-10"
                >
                  Download Spotter
                </a>
              </div>
