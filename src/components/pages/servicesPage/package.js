  ...
  <section className={styles.pricingSection}>
    <div>
         <div className={styles.price}>
           ...
           <h3>
             <span className={styles.dollarsign}>$</span><span className={styles.priceTitle}>{props.price}<br /> <span style={{fontSize: "1.5rem"}}>+ ${props.maintain === '0' ? '0' : '40'}</span></span> <span className={styles.month}>/MO OR just ${props.monthly} /MO</span>
           </h3>
           </div>
